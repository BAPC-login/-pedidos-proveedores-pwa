...
assert.match(combined,/index-v(?:32|33|34|36|38|39)\.js/);assert.match(combined,/2026\.08\.(?:05\.33|06\.(?:34|35|36|37|38|39|40))/);assert.match(sw,/nuvasto-v(?:32-professional-ux|33-history-documents|34-folio-invoice-visual|36-(?:invoice-review-save-icons|date-only-consistency)|38-multiple-invoices-per-order|39-multi-picker-cache-navigation)/);assert.match(sw,/app-runtime-v30\.js/);assert.match(sw,/app-order-detail-v30\.js/);assert.match(sw,/app-orders-v30\.js/);assert.match(sw,/app-history-bridge-v31\.js/);assert.match(pkg,/2\.0\.0-alpha\.(?:32|33|34|35|36)/);assert.match(pkg,/workflow-v30\.test\.mjs/);assert.match(pkg,/app-orders-v30\.js/);assert.match(pkg,/app-history-bridge-v31\.js/);
...
console.log('workflow v31 invoice storage and mobile reliability under Nuvasto v39: OK');
