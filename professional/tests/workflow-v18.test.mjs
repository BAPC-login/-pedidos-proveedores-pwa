...
assert.match(storage,/createProfessionalOrderPdfV(?:22|24)/);
assert.match(storage,/pdfVersion:(?:22|24)/);
...
assert.match(serviceWorker,/(?:v19-workflow-r2|v20-professional-sso|nuvasto-v21-brand-platform|nuvasto-v22-orders-pdf-motion|nuvasto-v23-auth-keyboard|nuvasto-v26-r2-invoice-keyboard|nuvasto-v29-invoice-checkout-r2)/);
...
console.log('workflow v18 compatibility under Nuvasto v29: OK');
