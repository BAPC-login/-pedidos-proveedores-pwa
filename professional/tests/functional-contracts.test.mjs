...
assert.ok(orderCore.includes('markLocalCleared()')&&orderCore.indexOf('markLocalCleared()')>orderCore.indexOf("api('/api/order-batches/v2'"),'local recovery data may only be cleared after the order batch save succeeds');
