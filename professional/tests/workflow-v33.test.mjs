...
assert.match(entry,/initializeDocumentsV33/);assert.match(entry,/documents/);assert.match(combined,/index-v36\.js/);assert.match(combined,/2026\.08\.06\.(?:37|38)/);assert.match(sw,/nuvasto-v36-(?:invoice-review-save-icons|date-only-consistency)/);assert.match(sw,/app-v33-documents\.js/);assert.match(pkg,/2\.0\.0-alpha\.36/);assert.match(pkg,/workflow-v33\.test\.mjs/);assert.match(pkg,/index-v33\.js/);assert.match(pkg,/app-v33-documents\.js/);

console.log('workflow v33 history and editable archive compatibility under v36 date hotfix: OK');
