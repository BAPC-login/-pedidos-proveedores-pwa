...
assert.match(entry,/initializeDocumentsV33/);assert.match(entry,/documents/);assert.match(combined,/index-v34\.js/);assert.match(combined,/2026\.08\.06\.35/);assert.match(sw,/nuvasto-v34-folio-invoice-visual/);assert.match(sw,/app-v33-documents\.js/);assert.match(pkg,/2\.0\.0-alpha\.34/);assert.match(pkg,/workflow-v33\.test\.mjs/);assert.match(pkg,/index-v33\.js/);assert.match(pkg,/app-v33-documents\.js/);

console.log('workflow v33 resilient history and editable archive compatibility under v34: OK');
