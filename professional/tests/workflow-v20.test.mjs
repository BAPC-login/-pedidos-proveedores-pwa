...
assert.match(combined,/index-v(?:20|21|22|26)\.js/);
assert.match(combined,/2026\.(?:07\.31\.(?:20|21|22)|08\.04\.26)/);
...
assert.match(serviceWorker,/(?:v20-professional-sso|nuvasto-v21-brand-platform|nuvasto-v22-orders-pdf-motion|nuvasto-v23-auth-keyboard|nuvasto-v26-r2-invoice-keyboard)/);
...
assert.match(pkg,/2\.0\.0-alpha\.(?:20|21|22|23|24|25|26)/);
