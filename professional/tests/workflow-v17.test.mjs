...
assert.match(serviceWorker,/(?:v17-readiness|v18-history-master-pdf|v19-workflow-r2|v20-professional-sso|nuvasto-v21-brand-platform|nuvasto-v22-orders-pdf-motion|nuvasto-v23-auth-keyboard|nuvasto-v23-screen-state-hotfix|nuvasto-v26-r2-invoice-keyboard)/);
