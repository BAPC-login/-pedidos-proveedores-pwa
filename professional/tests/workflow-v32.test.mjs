...
assert.match(combined,/index-v32\.js/);assert.match(combined,/2026\.08\.05\.33/);
...
assert.match(invoiceEntry,/app-v32-entry\.js/);assert.match(sw,/nuvasto-v32-professional-ux/);assert.match(sw,/app-v32-catalog\.js/);assert.match(pkg,/2\.0\.0-alpha\.32/);assert.match(pkg,/workflow-v32\.test\.mjs/);

console.log('workflow v32 professional UX, advanced filters, supplier matrix, photos and learning: OK');
