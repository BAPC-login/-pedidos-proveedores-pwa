...
assert.ok(sw.includes('nuvasto-v78-invoice-matrix-passkey-ledger')&&sw.includes('sessionCacheKey')&&sw.includes('apiDataResponse'),'service worker must provide authenticated offline data fallback and invalidate stale finance/catalog UI');
