...
assert.ok(sw.includes('nuvasto-v76-supplier-final-unit')&&sw.includes('sessionCacheKey')&&sw.includes('apiDataResponse'),'service worker must provide authenticated offline data fallback and invalidate stale invoice UI');
