...
assert.match(indexV29,/2\.0\.0-alpha\.29/);assert.match(indexV29,/invoiceFlowVersion:29/);assert.match(indexV29,/checkoutFlowVersion:29/);assert.match(indexV29,/folioRenumberingVersion:29/);assert.match(combined,/index-v29\.js/);assert.match(combined,/index-v36\.js/);assert.match(combined,/2026\.08\.06\.37/);assert.match(app,/app-invoice-entry-v29\.js/);assert.match(app,/initializeCheckoutInvoiceV29/);assert.match(sw,/nuvasto-v36-invoice-review-save-icons/);assert.match(sw,/app-checkout-upgrade-v29\.js/);assert.match(pkg,/app-checkout-upgrade-v29\.js/);assert.match(pkg,/2\.0\.0-alpha\.36/);

console.log('workflow v29 checkout compatibility under Nuvasto v36: OK');
