...
export function openInitialRouteV14(){const route=initialRoute(),valid=[...standard,'operations','receiving','history','enterprise','professional'].includes(route.view)?route:{view:'dashboard',subview:'',depth:0,scrollY:0};return openRoute(valid.view,valid.subview||'',{replace:true,restore:true,scrollY:valid.scrollY||0})}
export {openRoute};
