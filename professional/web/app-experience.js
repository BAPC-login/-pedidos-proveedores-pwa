...
function injectNavigation(){
  ...
  const bottom=$('.bottom-nav');if(bottom&&!bottom.dataset.experience){bottom.dataset.experience='1';bottom.innerHTML='<button class="bottom-item active" data-view="dashboard"><span>⌂</span><small>Inicio</small></button><button class="bottom-item" data-view="orders"><span>▤</span><small>Pedidos</small></button><button class="bottom-create" id="mobileCreate" type="button" aria-label="Nuevo pedido">＋</button><button class="bottom-item" data-experience-view="receiving"><span>⇣</span><small>Recepción</small></button><button class="bottom-item" data-view="settings"><span>☰</span><small>Más</small></button>'}
}
