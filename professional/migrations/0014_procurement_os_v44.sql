CREATE TABLE IF NOT EXISTS procurement_user_permissions (
  ...
  cost_center_scope TEXT NOT NULL DEFAULT '["*"]',
  max_order_amount INTEGER NOT NULL DEFAULT 0,
  can_create_orders INTEGER NOT NULL DEFAULT 0,
  can_emit_orders INTEGER NOT NULL DEFAULT 0,
  can_receive INTEGER NOT NULL DEFAULT 0,
  can_manage_catalog INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS product_favorites (
  ...
  created_at TEXT NOT NULL,
  PRIMARY KEY (org_id, user_id, cost_center_id, product_id)
);
...
CREATE TABLE IF NOT EXISTS work_jobs_v44 (
  id TEXT PRIMARY KEY,
  org_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS master_data_merge_events_v44 (
  id TEXT PRIMARY KEY,
  org_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS system_health_snapshots_v44 (
  id TEXT PRIMARY KEY,
  org_id TEXT NOT NULL,
