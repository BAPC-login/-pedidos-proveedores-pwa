...
export async function listOrdersV2(env,actor,url){
  ...
  const result=await env.DB.prepare(`
    SELECT o.id,o.folio,o.status,o.delivery_date,o.notes,o.currency,o.net_total,o.tax_total,o.gross_total,
      ...
      (SELECT COALESCE(SUM(i.gross_total),0) FROM invoice_order_links iol JOIN invoices i ON i.id=iol.invoice_id WHERE iol.org_id=o.org_id AND iol.order_id=o.id) AS invoiced_gross_total,
