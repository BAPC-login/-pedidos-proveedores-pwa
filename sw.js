const VERSION='pedidos-pro-v18-1';
const CORE_CACHE=`${VERSION}-core`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=['./','./index.html','./styles-v12.css?v=17','./patch-v17.css?v=17','./manifest.webmanifest?v=17','./assets/icon.svg?v=17','./assets/patch-v18.css?v=18','./assets/invoice-ui-v18.js?v=18','./seed-1.js?v=17','./seed-2.js?v=17','./seed-3.js?v=17','./seed-4.js?v=17','./core-v12.js?v=17','./db-v12.js?v=17','./state-v12.js?v=17','./orders-v12.js?v=17','./preflight-v17.js?v=17','./invoice-v12.js?v=17','./ai-client-v17.js?v=18-1','./pdf-v12.js?v=17','./pdf-layout-v17.js?v=17','./app-v12.js?v=17','./professional-v17.js?v=17'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.hostname==='pedidos-pro-ai.botreservasmultilocal.workers.dev')return;
  ...
  if(url.origin===self.location.origin){
    ...
    event.respondWith(fetch(event.request,vendor?{}:{cache:'no-store'}).then(response=>{if(response.ok)caches.open(vendor?RUNTIME_CACHE:CORE_CACHE).then(cache=>cache.put(event.request,response.clone()));return response}).catch(()=>caches.match(event.request)));return;
  }
