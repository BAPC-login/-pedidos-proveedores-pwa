const VERSION='pedidos-pro-v22';
const CORE_CACHE=`${VERSION}-core`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=['./','./index.html','./styles-v12.css?v=17','./patch-v17.css?v=17','./manifest.webmanifest?v=17','./assets/icon.svg?v=17','./assets/patch-v18.css?v=22','./assets/invoice-ui-v18.js?v=22','./seed-1.js?v=17','./seed-2.js?v=17','./seed-3.js?v=17','./seed-4.js?v=17','./core-v12.js?v=17','./db-v12.js?v=17','./state-v12.js?v=17','./orders-v12.js?v=17','./preflight-v17.js?v=17','./invoice-v12.js?v=17','./ai-client-v17.js?v=22','./pdf-v12.js?v=17','./pdf-layout-v17.js?v=17','./app-v12.js?v=17','./professional-v17.js?v=17'];
